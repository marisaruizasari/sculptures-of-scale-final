...
imgDiv1.className = "landing-img-div-1"
var imgDiv2 = document.createElement("div")
imgDiv2.className = "landing-img-div-2"
...
document.getElementById("landing-images-1").appendChild(imgDiv1);
document.getElementById("landing-images-2").appendChild(imgDiv2);
...
function myFunction(x) {
  if (x.matches) { // If media query matches
    ...
    testSlider = d3.select('div#slider-test').append('svg').attr('width', 400).attr('height', 80).append('g').attr('transform', 'translate(5,-15)').attr("class", "slider-svg").attr("id", "slider-svg");
    // .attr("class", "slider-container");
    slider2 = d3.sliderBottom().min(0).max(550).width(300).ticks(5).default([0, 550]).fill('#55585C').on('onchange', val => {
    ...
    testSlider = d3.select('div#slider-test').append('svg').attr('width', 80).attr('height', 350).append('g').attr('transform', 'translate(5,-15)').attr("class", "slider-svg").attr("id", "slider-svg");
    // .attr("class", "slider-container");
